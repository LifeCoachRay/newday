...
Every module in the newday, pillarjs, and jshttp organizations should have
...
Use the [README template](https://github.com/LifeCoachRay/newday/blob/main/Readme.md)
...
- Optional: a simple "hello world" type example (where applicable). This
  example is in addition to the more comprehensive examples later.
