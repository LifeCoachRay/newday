...
The newday project is part of the OpenJS Foundation which operates
...
Newday is a HTTP web server framework with a simple and expressive API
...
Newday is made of many modules spread between three GitHub Orgs:

- [newday](https://github.com/LifeCoachRay/newday): Top level middleware and
  libraries
- [pillarjs](http://github.com/pillarjs/): Components which make up
  newday but can also be used for other web frameworks
...
Cross Project Council (CPC). In the case of the newday project, it is
delegated to the newday Technical Committee ("TC").
...
## Section 3: Newday Governing Body

The newday project is managed by the Technical Committee ("TC").
...
The newday TC manages all aspects of both the technical and community
...
The newday TC uses a "consensus seeking" process for issues that are
